...
def send_welcome(message):
    welcome_text = """
🤖 *Vmess Account Generator Bot*

*Available Commands:*
`/buatvmess` - Buat akun Vmess baru
`/info` - Info bot

Bot ini akan membantu Anda membuat konfigurasi Vmess secara otomatis.
    """
...
*Features:*
• Generate Vmess accounts automatically
• Multiple protocol support (WS, gRPC, HTTP Upgrade)
...
if __name__ == "__main__":
    print("🤖 Bot Vmess Account Generator sedang berjalan...")
    print("📍 Token:", TOKEN)
